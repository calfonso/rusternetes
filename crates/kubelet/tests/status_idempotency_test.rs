...
fn make_succeeded_pod() -> Pod {
    let init_status = ContainerStatus {
        ...
        state: Some(ContainerState::Terminated {
            ...
            message: None,
            started_at: Some("2026-05-13T10:00:00Z".parse().unwrap()),
            finished_at: Some("2026-05-13T10:00:01Z".parse().unwrap()),
    ...
    let app_status = ContainerStatus {
        ...
        state: Some(ContainerState::Terminated {
            ...
            reason: Some("Completed".to_string()),
            message: None,
            started_at: Some("2026-05-13T10:00:02Z".parse().unwrap()),
            finished_at: Some("2026-05-13T10:00:05Z".parse().unwrap()),
